...
def evaluate(args,
    ...
    with torch.no_grad():
        ...
        for batch_idx, (data_1, data_2, data_3, data_4, ppa_t1, ppa_t2, ppa_t3, target_ppa, feature_1, feature_2, feature_3, feature_4,
            ...
            res_feature_4_1 = generate_feature_4_by_123 - featuremap_1
            res_feature_4_2 = generate_feature_4_by_123 - featuremap_2
            res_feature_4_3 = generate_feature_4_by_123 - featuremap_3

            real_res_4_1 = featuremap_4 - featuremap_1
            real_res_4_2 = featuremap_4 - featuremap_2
            real_res_4_3 = featuremap_4 - featuremap_3
            
            order3_feature_43_32 = (generate_feature_4_by_123 - featuremap_3) - (featuremap_3 - featuremap_2)
            order3_feature_42_31 = (generate_feature_4_by_123 - featuremap_2) - (featuremap_3 - featuremap_1)
            order3_feature_32_21 = (featuremap_3 - featuremap_2) - (featuremap_2 - featuremap_1)
            ...
            if args.is_plot == 1:
                ...
                for i in range(data_1.size(0)):
                    ...
                    if target_ppa[i] == args.what_plot:
            
                        save_dir = '../Feature_map/%s-Label%s/' % (args.sequence, args.what_plot)
                        ### order3 feature
                        unet_feature1_1 = order3_feature_43_32[i, :, :, :]  # add the unnomarlization
                        ...
                        save_dir0 = (save_dir + 'order3_feature/')
                        draw_features(16, 8, unet_feature1_1, save_dir0, image_sequence, test_loader,
                                      'order3_%s-%s_minus_%s-%s_' % (grade + 3, grade + 2, grade + 2, grade+1),
                                      args.batch_size, args.dpi, args.is_local_normal, args)

                        unet_feature1_1 = order3_feature_42_31[i, :, :, :]  # add the unnomarlization
                        unet_feature1_1 = torch.unsqueeze(unet_feature1_1, 0)
                        if args.plot_sigmoid:
                            unet_feature1_1 = torch.sigmoid(unet_feature1_1)
                        unet_feature1_1 = unet_feature1_1.cpu().detach().numpy()
                        #save_dir0 = (save_dir + 'order3_feature/')
                        draw_features(16, 8, unet_feature1_1, save_dir0, image_sequence, test_loader,
                                      'order3_%s-%s_minus_%s-%s_' % (grade + 3, grade + 1, grade + 2, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        
                        unet_feature1_1 = order3_feature_32_21[i, :, :, :]  # add the unnomarlization
                        unet_feature1_1 = torch.unsqueeze(unet_feature1_1, 0)
                        if args.plot_sigmoid:
                            unet_feature1_1 = torch.sigmoid(unet_feature1_1)
                        unet_feature1_1 = unet_feature1_1.cpu().detach().numpy()
                        #save_dir0 = (save_dir + 'order3_feature/')
                        draw_features(16, 8, unet_feature1_1, save_dir0, image_sequence, test_loader,
                                      'order3_%s-%s_minus_%s-%s_' % (grade + 2, grade + 1, grade + 1, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ...
                        draw_features(16, 8, unet_feature1_1, save_dir1, image_sequence, test_loader,
                                      'generate_%s_by_%s%s%s_' % (grade + 3, grade + 2, grade + 1, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ### minus
                        minus_feature3_1 = res_feature_4_1[i, :, :, :]
                        ...
                        draw_features(16, 8, minus_feature3_1, save_dir2, image_sequence, test_loader,
                                      'generate_res_%s-%s_' % (grade + 3, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
            
                        minus_feature3_2 = res_feature_4_2[i, :, :, :]
                        ...
                        draw_features(16, 8, minus_feature3_2, save_dir2, image_sequence, test_loader,
                                      'generate_res_%s-%s_' % (grade + 3, grade + 1),
                                      args.batch_size, args.dpi, args.is_local_normal, args)

                        minus_feature3_3 = res_feature_4_3[i, :, :, :]
                        minus_feature3_3 = torch.unsqueeze(minus_feature3_3, 0)
                        if args.plot_sigmoid:
                            minus_feature3_3 = torch.sigmoid(minus_feature3_3)
                        minus_feature3_3 = minus_feature3_3.cpu().detach().numpy()
                        #save_dir2 = (save_dir + 'generate_res_')
                        draw_features(16, 8, minus_feature3_3, save_dir2, image_sequence, test_loader,
                                      'generate_res_%s-%s_' % (grade + 3, grade + 2),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ### minus-minus
                        minus_feature3_1 = res_feature_4_1[i, :, :, :].mul(-1)
                        minus_feature3_1 = torch.unsqueeze(minus_feature3_1, 0)
                        if args.plot_sigmoid:
                            minus_feature3_1 = torch.sigmoid(minus_feature3_1)
                        minus_feature3_1 = minus_feature3_1.cpu().detach().numpy()
                        ...
                        draw_features(16, 8, minus_feature3_1, save_dir3, image_sequence, test_loader,
                                      'generate_res-minus_%s-%s_' % (grade + 3, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
            
                        minus_feature3_2 = res_feature_4_2[i, :, :, :].mul(-1)
                        minus_feature3_2 = torch.unsqueeze(minus_feature3_2, 0)
                        if args.plot_sigmoid:
                            minus_feature3_2 = torch.sigmoid(minus_feature3_2)
                        minus_feature3_2 = minus_feature3_2.cpu().detach().numpy()
                        ...
                        draw_features(16, 8, minus_feature3_2, save_dir3, image_sequence, test_loader,
                                      'generate_res-minus_%s-%s_' % (grade + 3, grade + 1),
                                      args.batch_size, args.dpi, args.is_local_normal, args)

                        minus_feature3_3 = res_feature_4_3[i, :, :, :].mul(-1)
                        minus_feature3_3 = torch.unsqueeze(minus_feature3_3, 0)
                        if args.plot_sigmoid:
                            minus_feature3_3 = torch.sigmoid(minus_feature3_3)
                        minus_feature3_3 = minus_feature3_3.cpu().detach().numpy()
                        #save_dir3 = (save_dir + 'generate_res-minus')
                        draw_features(16, 8, minus_feature3_3, save_dir3, image_sequence, test_loader,
                                      'generate_res-minus_%s-%s_' % (grade + 3, grade + 2),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ...
                        featuremap_4_1 = featuremap_4[i, :, :, :]
                        featuremap_4_1 = torch.unsqueeze(featuremap_4_1, 0)
                        if args.plot_sigmoid:
                            featuremap_4_1 = torch.sigmoid(featuremap_4_1)
                        featuremap_4_1 = featuremap_4_1.cpu().detach().numpy()
                        #save_dir4 = (save_dir + 'real_')
                        draw_features(16, 8, featuremap_4_1, save_dir4, image_sequence, test_loader, 'real4_',
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ### real res feature
                        minus_feature3_1 = real_res_4_1[i, :, :, :]
                        minus_feature3_1 = torch.unsqueeze(minus_feature3_1, 0)
                        if args.plot_sigmoid:
                            minus_feature3_1 = torch.sigmoid(minus_feature3_1)
                        minus_feature3_1 = minus_feature3_1.cpu().detach().numpy()
                        ...
                        draw_features(16, 8, minus_feature3_1, save_dir5, image_sequence, test_loader,
                                      'real_res_%s-%s_' % (grade + 3, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
            
                        minus_feature3_2 = real_res_4_2[i, :, :, :]
                        minus_feature3_2 = torch.unsqueeze(minus_feature3_2, 0)
                        if args.plot_sigmoid:
                            minus_feature3_2 = torch.sigmoid(minus_feature3_2)
                        minus_feature3_2 = minus_feature3_2.cpu().detach().numpy()
                        ...
                        draw_features(16, 8, minus_feature3_2, save_dir5, image_sequence, test_loader,
                                      'real_res_%s-%s_' % (grade + 3, grade + 1),
                                      args.batch_size, args.dpi, args.is_local_normal, args)

                        minus_feature3_3 = real_res_4_3[i, :, :, :]
                        minus_feature3_3 = torch.unsqueeze(minus_feature3_3, 0)
                        if args.plot_sigmoid:
                            minus_feature3_3 = torch.sigmoid(minus_feature3_3)
                        minus_feature3_3 = minus_feature3_3.cpu().detach().numpy()
                        #save_dir5 = (save_dir + 'real_res_')
                        draw_features(16, 8, minus_feature3_3, save_dir5, image_sequence, test_loader,
                                      'real_res_%s-%s_' % (grade + 3, grade + 2),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ### real res-minus feature
                        minus_feature3_1 = real_res_4_1[i, :, :, :].mul(-1)
                        minus_feature3_1 = torch.unsqueeze(minus_feature3_1, 0)
                        if args.plot_sigmoid:
                            minus_feature3_1 = torch.sigmoid(minus_feature3_1)
                        minus_feature3_1 = minus_feature3_1.cpu().detach().numpy()
                        ...
                        draw_features(16, 8, minus_feature3_1, save_dir6, image_sequence, test_loader,
                                      'real_res-minus_%s-%s_' % (grade + 3, grade),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
            
                        minus_feature3_2 = real_res_4_2[i, :, :, :].mul(-1)
                        minus_feature3_2 = torch.unsqueeze(minus_feature3_2, 0)
                        if args.plot_sigmoid:
                            minus_feature3_2 = torch.sigmoid(minus_feature3_2)
                        minus_feature3_2 = minus_feature3_2.cpu().detach().numpy()
                        #save_dir5 = (save_dir + 'real_res-minus_')
                        draw_features(16, 8, minus_feature3_2, save_dir6, image_sequence, test_loader,
                                      'real_res-minus_%s-%s_' % (grade + 3, grade + 1),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
                        ...
                        minus_feature3_3 = minus_feature3_3.cpu().detach().numpy()
                        #save_dir5 = (save_dir + 'real_res-minus_')
                        draw_features(16, 8, minus_feature3_3, save_dir6, image_sequence, test_loader,
                                      'real_res-minus_%s-%s_' % (grade + 3, grade + 2),
                                      args.batch_size, args.dpi, args.is_local_normal, args)
...
def main():
    ...
    load_pytorch_model(model_1,
                       r'../results/Ecur_2201-Ours-order3/2024-06-29-16-12-39_Mixed_0.000200_40.000000_size_256_ep_120_0_R_Maculae/best_val_auc_model_1.pt')
    for ss in range(len(model_2_list)):
        load_pytorch_model22(model_2_list[ss],
                             r'../results/Ecur_2201-Ours-order3/2024-06-29-16-12-39_Mixed_0.000200_40.000000_size_256_ep_120_0_R_Maculae/best_val_auc_model_2_list.pt',
                             list=ss)
    for ii in range(len(G_net_list)):
        load_pytorch_model22(G_net_list[ii],
                             r'../results/Ecur_2201-Ours-order3/2024-06-29-16-12-39_Mixed_0.000200_40.000000_size_256_ep_120_0_R_Maculae/best_val_auc_G_net_list.pt',
                             list=ii)
    optimizer_M_2_list = []
    optimizer_G_list = []
    ...
    try:
        ...
        args.logger.info('Ours method-order3_plot_visualization')
        args.logger.info('-' * 50)
        args.logger.info('-' * 50)
        args.logger.info('-' * 50)
