    ...
    def __init__(self,
        ...
        if filename == 'std_all':
            ...
            workbook1 = xlrd.open_workbook(
                r"../ppa-classi-dataset-onuse/ppa_06-29-order3-std-8.xls")
    ...
    for batch_idx, (data_1, data_2, data_3, data_4, target_ppa, feature_1, feature_2, feature_3, feature_4,
        ...
        if batch_idx % 5 < args.D_epoch:
            ...
            P_pred = [torch.softmax(model_2_list[1](featuremap_1, feature_1,
                                    ...
                                    model_2_list[1](featuremap_2, feature_2,
                                                    idx1=(grad_3 - grad_2 - 1).view(
                                                        data_2.size(0), ).detach().cpu().numpy()) + \
                                    model_2_list[0](featuremap_3), dim=1),
            ...
            P_pred_gen = [
                ...
                model_2_list[0](featuremap_3),
                model_2_list[0](generate_feature_4_by_123),
            ]
...
def main():
    ...
    load_pytorch_model(model_1,
                       r'../results/Ecur_10-13/order3-ours-02/2020-10-14-13-18-28_Mixed_0.001000_60.000000_size_256_ep_140_0_R_Maculae/best_val_auc_model_1.pt')
    for ss in range(len(model_2_list)):
        load_pytorch_model22(model_2_list[ss],
                             r'../results/Ecur_10-13/order3-ours-02/2020-10-14-13-18-28_Mixed_0.001000_60.000000_size_256_ep_140_0_R_Maculae/best_val_auc_model_2_list.pt',
                             list=ss)
    for ii in range(len(G_net_list)):
        load_pytorch_model22(G_net_list[ii],
                             r'../results/Ecur_10-13/order3-ours-02/2020-10-14-13-18-28_Mixed_0.001000_60.000000_size_256_ep_140_0_R_Maculae/best_val_auc_G_net_list.pt',
                             list=ii)
