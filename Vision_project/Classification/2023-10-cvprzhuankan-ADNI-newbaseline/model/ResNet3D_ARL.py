...
class ARLBlock(nn.Module):
    # Attention Residual Learning
    expansion = 1

    def __init__(self, in_planes, planes, stride=1, downsample=None, alpha=0.001):
        super().__init__()
...
if __name__ == '__main__':
    model1 = RN18_extrator(block=ARLBlock)
    model2 = RN18_generator(block=ARLBlock)
    model3 = RN18_ARL()
    batch = torch.rand([4, 1, 128, 128, 128])
    output = model3(batch)
