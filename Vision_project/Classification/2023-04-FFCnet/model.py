...
class BottleNeck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = Sequential_complex(
            ...
            ComplexConv2d(out_channels, out_channels, stride=stride,
                          kernel_size=3, padding=1, bias=False),
            ComplexBatchNorm2d(out_channels),
            ComplexReLU(inplace=True),
        ...
        if stride != 1 or in_channels != out_channels * BottleNeck.expansion:
            self.shortcut = Sequential_complex(
                ComplexConv2d(in_channels, out_channels * BottleNeck.expansion,
...
def resnet18(num_classes=4, inputchannel=3):
    ...
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, inputchannel=3)
