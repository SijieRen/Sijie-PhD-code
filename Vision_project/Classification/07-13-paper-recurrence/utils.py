...
def get_opts():
    ...
    parser.add_argument('--wd3', type=float, default=0.0001, help='')
    parser.add_argument('--lossC_data1', type=float, default=1, help='')
    ...
    parser.add_argument('--lossG', type=float, default=1)
    # Dataset
    ...
    parser.add_argument('--gantype', type=str, default='small',
                        help='hyper-parameter for gradient panelty')
    ...
    parser.add_argument('--Routch', type=int, default='half')
...
def save_results_as_xlsx(root, args=None):
    ...
    if not os.path.exists(os.path.join(root, args.xlsx_name)):
        ...
        worksheet.write(0, 7, 'lr2')
        worksheet.write(0, 8, 'lr3')
        ...
        worksheet.write(0, 18, 'lambda_C')
        worksheet.write(0, 19, 'lossC_data1')
        worksheet.write(0, 20, 'lossC')
        worksheet.write(0, 21, 'lambda_R')
        worksheet.write(0, 22, 'lossR')
        ...
        worksheet.write(idx, 7, args.lr2)
        worksheet.write(idx, 8, args.lr3)
        ...
        worksheet.write(idx, 18, args.lambda_C)
        worksheet.write(idx, 19, args.lossC_data1)
        worksheet.write(idx, 20, args.lossC)
        worksheet.write(idx, 21, args.lambda_R)
        worksheet.write(idx, 22, args.lossR)
