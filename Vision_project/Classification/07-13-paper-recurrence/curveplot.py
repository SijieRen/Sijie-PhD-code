...
for i in range(1, len(data) + 1):
	...
	loss_train_D.append(data[i]['train_results']['loss_D'])
	...
	#auc_val.append(data[i]['val_results_list'][2]['AUC_average_all'])
...
plt.plot(ep[:], loss_train_D[:], c='green', label='loss_trian_D')
...
#plt.plot(ep[:], auc_val[:], c='maroon', label='auc_val')
