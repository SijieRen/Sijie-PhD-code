...
def get_opts():
    ...
    ### 11-03-paper-reproduce
    parser.add_argument('--rec_weight', type=float, default=0.1, help='learning rate (default: 0.0001)')
    parser.add_argument('--cnn-layer', type=int, default=5, help='cnn layers')
    parser.add_argument('--z-size', type=int, default=5, metavar='G', help='latent size of z in vae (default: 512)')
    parser.add_argument('--h-dim', type=int, default=128, help='h dim')
...
def save_results_as_xlsx(root, args=None):
    ...
    if not os.path.exists(os.path.join(root, args.xlsx_name)):
        ...
        worksheet.write(0, 18, 'rec-weight')
        ...
        worksheet.write(idx, 18, args.rec_weight)
