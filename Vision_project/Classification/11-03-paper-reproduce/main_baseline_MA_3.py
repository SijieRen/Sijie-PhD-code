...
def train_baseline(args,
    ...
    for batch_idx, (data_1, data_2, data_3, data_4, target_ppa, feature_1, feature_2, feature_3, feature_4,
        ...
        data_4_ = data_4.unsqueeze(1)
        
        rec_sequences, logit, phi = model(torch.cat([data_1_, data_2_, data_3_, data_4_], 1), data_1.size(0),
                                              torch.cat([feature_1, feature_2, feature_3], 1))
        ...
        train_loss_1.update(mean_rec_loss.item() * args.rec_weight, data_1.size(0))
...
def main():
    ...
    if args.optimizer == 'Adam':
        ...
        model_optimizer = optim.SGD([{'params': model.parameters(), 'lr': args.lr,
    ...
    try:
        for epoch in range(1, args.epochs + 1):
            args.logger.info("RGL-order3333333333333333333333333333")
