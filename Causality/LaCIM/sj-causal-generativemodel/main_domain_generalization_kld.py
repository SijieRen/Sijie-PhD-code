...
def main():
    ...
    pytorch_total_params = pytorch_total_params + sum(p.numel() for p in D_net.parameters())
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        adjust_learning_rate(optimizer_D, epoch, args.lr2, args.lr_decay, args.lr_controler)
        _, _ = train(
            epoch,
            model,
            D_net,
