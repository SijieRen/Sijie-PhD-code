...
# 大模型
class InferenceNet_big(nn.Module):
    def __init__(self, x_dim, z_dim, y_dim):
        super(InferenceNet_big, self).__init__()
...
# Generative Network
class GenerativeNet_big(nn.Module):
    def __init__(self, x_dim, z_dim, y_dim):
        super(GenerativeNet_big, self).__init__()
...
class GMVAENet_big(nn.Module):
    def __init__(self, x_dim, z_dim, y_dim):
        super(GMVAENet_big, self).__init__()

        self.inference = InferenceNet_big(x_dim, z_dim, y_dim)
        self.generative = GenerativeNet_big(x_dim, z_dim, y_dim)
