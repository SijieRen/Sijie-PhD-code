...
def get_opt():
    ...
    parser.add_argument('--whole_iter', type=int, default=1)
    parser.add_argument('--overall_threshold', type=float, default=0.2)

    # IB_IRM
    parser.add_argument('--irm_lambda', type=float, default=0.2)
    parser.add_argument('--ib_lambda', type=float, default=0.2)
