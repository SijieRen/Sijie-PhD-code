...
class MM_F_2D_NICO(nn.Module):
    def __init__(self,
        ...
        self.get_feature = nn.Sequential(
            self.Conv_bn_ReLU(self.in_channel, self.in_channel,
        ...
        self.fc = nn.Sequential(
            ...
            self.Fc_bn_ReLU(512, self.zs_dim),
...
class MM_F_2D_Cmnist(nn.Module):
    def __init__(self,
                 in_channel=1,
                 u_dim=2,
                 us_dim=6,
        ...
        super(MM_F_2D_Cmnist, self).__init__()
        self.in_channel = in_channel
        self.is_use_u = is_use_u
        self.u_dim = u_dim
        self.us_dim = us_dim
...
class MM_F_3D_AD(nn.Module):
    def __init__(self,
        ...
        super(MM_F_3D_AD, self).__init__()
        self.in_channel = in_channel
        self.is_use_u = is_use_u
        self.u_dim = u_dim
        self.us_dim = us_dim
