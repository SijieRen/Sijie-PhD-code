...
def main():
    ...
    if args.model == 'VAE_f_share':  # sijie NIPS 2021
        if "mnist" in args.dataset:
    ...
    if args.inference_only and args.load_path != '':
        ...
        save_pred_label_as_xlsx(
            args.model_save_dir, 'pred.xls', pred_test, label_test, test_loader, args)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if test_acc >= best_acc:
            ...
            is_best = 1
            logger.info('test acc: %0.4f, test_ep: %d, lr: %0.5f, wd: %0.5f, sample %d'
                        % (test_acc, args.test_ep, args.lr, args.reg2, args.sample_num))
