...
class params(object):
    def __init__(self):
        ...
        # env=2 9820 /results/mnist_2/save_model_VAE_f_share_test_32_4704.0_0.1_lr_0.0100_80_0.5000_wd_0.0005_2022-12-02_22-58-39/
        # 9746 /results/mnist_2/save_model_VAE_f_share_test_32_4704.0_0.1_lr_0.0100_80_0.5000_wd_0.0005_2023-05-20_13-25-44
        self.eval_path = '/home/ruxin2/PPA-classification-prediction/Causality/results/mnist_2/save_model_VAE_f_share_test_32_4704.0_0.1_lr_0.0100_80_0.5000_wd_0.0005_2023-06-29_12-35-44'
...
model.eval()
nums = 19
# instance_num = [10, 12, 666, 668, 2800, 1330, 1340, 4400,
#                 4420, 3700, 3710, 6600, 6680, 7924, 8848, 9924, 9249]
# instance_num = [4400, 3710, 6600, 7924, 9249, 9250, 9251]
instance_num = [9249, 8123, 5144]
#9 9249, 9250, 9251,
#8 8120, 8121, 8122, 8123, 8124, 8125,
#6 5141, 5142, 5143, 5144, 5145,
#6 3580, 3581, 3582, 3583, 3584,
...
for dim in range(6, 9):
    ...
    for i in range(z_init.shape[0]):
        if i in instance_num:
            ...
            # plt.imshow(plot_img)
            if not os.path.exists('./SB_923_5_selection_bias_saved_img_fix_s/'):
                os.makedirs('./SB_923_5_selection_bias_saved_img_fix_s/')
            plt.imsave('./SB_923_5_selection_bias_saved_img_fix_s/fix_s_dim%03d_%05d.png' % (
                dim, i), plot_img)
...
for dim in range(10, 13):
    ...
    for i in range(z_init.shape[0]):
        if i in instance_num:
            ...
            plot_img = np.concatenate(img_list, axis=1)
            # plt.imshow(plot_img)
            if not os.path.exists('./SB_923_5_selection_bias_saved_img_fix_z/'):
                os.makedirs('./SB_923_5_selection_bias_saved_img_fix_z/')
            plt.imsave('./SB_923_5_selection_bias_saved_img_fix_z/fix_z_dim%03d_%05d.png' %
                       (dim, i), plot_img)
