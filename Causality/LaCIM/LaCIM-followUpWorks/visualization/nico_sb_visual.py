...
def evaluate(epoch, model_1, model_2, dataloader, args):
    ...
    for batch_idx, (x, target, env, u) in enumerate(dataloader):
        if x.size(0) == 1:
            ...
            ERM
            """
            saliency_erm = compute_saliency_maps_erm(x_erm, target, model_2)
            ...
            if not os.path.exists('./911_72clone_%s_sb_visual_NICO_%s/' % (args.color, args.fold)):
                os.makedirs('./911_72clone_%s_sb_visual_NICO_%s/' % (args.color, args.fold))
            ...
            fig_erm.savefig('./911_72clone_%s_sb_visual_NICO_%s/%03d.png' % 
        ...
        print("sb:", args.color, "-", batch_begin, "-", args.fold)
...
class params(object):
    def __init__(self):
        ...
        # env=2
        # 2023-09-09 20:47:24,847 - AL - INFO - init_acc: 0.5500, after acc: 0.6200
        # 2023-09-09 20:47:24,847 - AL - INFO - test acc: 0.6200, test_ep: 100, lr: 0.01000, wd: 0.08000, sample 10
        # 2023-09-09 20:47:25,015 - AL - INFO - Checkpoint saved to ../results/NICO/save_model_VAE_f_share_NICO_10_2_10.0_0.1_lr_0.0100_
        # 60_0.5000_wd_0.0005_2023-09-09_20-37-16/best_acc.pth.tar

        # 2023-09-11 20:44:55,481 - AL - INFO - epoch 150:, current test_acc: 0.5100, best_acc: 0.7200, at ep 93, val_acc: -1.0000
        # 2023-09-11 20:44:55,517 - AL - INFO - model save path: ../results/NICO/save_model_VAE_f_share_NICO_10_2_10.0_0.1_lr_0.0010_60_0.5000_wd_0.0005_2023-09-11_18-27-37/

        # 2023-09-11 20:44:18,747 - AL - INFO - epoch 150:, current test_acc: 0.5400, best_acc: 0.6700, at ep 138, val_acc: -1.0000
        # 2023-09-11 20:44:18,803 - AL - INFO - model save path: ../results/NICO/save_model_VAE_f_share_NICO_10_2_10.0_0.1_lr_0.0020_80_0.4000_wd_0.0005_2023-09-11_18-27-18/

        self.eval_path = '/home/ruxin2/PPA-classification-prediction/Causality/results/NICO/save_model_VAE_f_share_NICO_10_2_10.0_0.1_lr_0.0010_60_0.5000_wd_0.0005_2023-09-11_18-27-37'
...
check_1 = torch.load('%s/best_acc.pth.tar' % args.eval_path,
...
class params2(object):
    def __init__(self):
        ...
        ### 
        self.eval_path = '/home/ruxin2/PPA-classification-prediction/Causality/results/NICO/save_model_MM_F_f_test_1_0.5_0.1_lr_0.1000_60_0.5000_wd_0.0001_2023-08-29_20-18-27'
